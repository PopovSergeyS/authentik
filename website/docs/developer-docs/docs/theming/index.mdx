...
import { PaletteGroup, ColorGroup } from "@goauthentik/docusaurus-theme/components/infima/Swatch/index.tsx";
import { DispositionDangerColorEntries, DispositionInfoColorEntries, DispositionSuccessColorEntries, DispositionWarningColorEntries, InfimaColorsMap, UtilityColorEntries } from "@goauthentik/docusaurus-theme/components/infima/constants.ts";
